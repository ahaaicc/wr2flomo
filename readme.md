...
### 开箱即用
[**下载 WR2Flomo.exe** ↵ ](https://github.com/chaozhoo/wr2flomo/releases/download/v0.5.0/WR2Flomo.exe)双击打开即可开始导入，首次打开点击 `新建笔记` ，选择数据文件的保存位置（记得放在容易找到的地方）
